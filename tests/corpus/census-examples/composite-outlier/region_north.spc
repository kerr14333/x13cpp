# Composite outlier gate — component series 1 of 2 (North region).
#
...
#
# THIS component carries the level shift. AdjLS is 1 by default (the LS effect
# is removed from the seasonally adjusted series and not kept in it), which is
# what sets agr2.f:233's LindLS and so makes the Lindot conjunctions live.
series{
