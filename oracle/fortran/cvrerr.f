...
c     ------------------------------------------------------------------
      ...
      IF(idif.lt.0)THEN
       ...
       WRITE(Mt2,1010)Spnttl,chrdt1(1:nchr1),Srsttl,chrdt2(1:nchr2)
...
c     ------------------------------------------------------------------
      IF(Nobs-idif.lt.Nspobs)THEN
       ...
       WRITE(Mt2,1020)Spnttl,chrdt1(1:nchr1),Srsttl,chrdt2(1:nchr2)
...
c     ------------------------------------------------------------------
      IF(Nspobs.le.0)THEN
       ...
       WRITE(Mt2,1030)Spnttl,chrdt1(1:nchr1),chrdt2(1:nchr2)
