...
C COMMON variables
C
      character*(PFILCR) Infile,Cursrs,Curgrf
      LOGICAL Opnsin,Opnsot,Opnudg,Lquiet
      INTEGER Fillst(PFILE),Nfile,Nfilcr,Ngrfcr,Grfout,Imeta
      COMMON /cstdio/Nfile,Nfilcr,Ngrfcr,Grfout,Imeta,Fillst,STDERR
      COMMON /cstdc/Infile,Cursrs,Curgrf
      COMMON /cstdlg/Opnsin,Opnsot,Opnudg,Lquiet
