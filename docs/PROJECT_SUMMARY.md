...
- **Parity suite result:** **<!--x13:parity_pass-->6000<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->474<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-08-01<!--/x13-->), plus <!--x13:ctest-->12/12<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
...
| Active development time | **<!--x13:active_time-->60h 04m<!--/x13-->** over <!--x13:calendar_days-->15<!--/x13--> calendar days | `worklog.py`, gaps >45m excluded |
| Commits | <!--x13:commits-->386<!--/x13--> | 2026-07-18 → 2026-07-29 |
