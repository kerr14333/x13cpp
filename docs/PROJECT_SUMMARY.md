...
- **Parity suite result:** **<!--x13:parity_pass-->5944<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->470<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-07-31<!--/x13-->), plus <!--x13:ctest-->11/11<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
...
| Metric | Value | Notes |
|---|---|---|
| C++ written | **<!--x13:cpp_lines-->46531<!--/x13--> non-blank lines**, <!--x13:cpp_files-->182<!--/x13--> files | excludes generated COMMON headers |
...
| Active development time | **<!--x13:active_time-->59h 34m<!--/x13-->** over <!--x13:calendar_days-->14<!--/x13--> calendar days | `worklog.py`, gaps >45m excluded |
| Commits | <!--x13:commits-->381<!--/x13--> | 2026-07-18 → 2026-07-29 |
