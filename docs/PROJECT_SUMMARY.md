...
- **Parity suite result:** **<!--x13:parity_pass-->9034<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->942<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-08-13<!--/x13-->), plus <!--x13:ctest-->12/12<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
