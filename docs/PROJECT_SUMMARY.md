...
- **Parity suite result:** **<!--x13:parity_pass-->6977<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->761<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-08-05<!--/x13-->), plus <!--x13:ctest-->12/12<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
- **Corpus:** <!--x13:corpus_specs-->453<!--/x13--> spec files across <!--x13:parity_modules-->31<!--/x13--> parity test modules, spanning the airline model, Census example series, real economic series (unemployment, payroll employment, exports), and unedited production specs from the BLS Current Employment Statistics program.
...
| Metric | Value | Notes |
|---|---|---|
| C++ written | **<!--x13:cpp_lines-->49260<!--/x13--> non-blank lines**, <!--x13:cpp_files-->183<!--/x13--> files | excludes generated COMMON headers |
...
| Parity result | <!--x13:parity_pass-->6977<!--/x13--> pass / <!--x13:parity_fail-->0<!--/x13--> fail / <!--x13:parity_xfail-->0<!--/x13--> xfail / <!--x13:parity_skip-->761<!--/x13--> skip | plus ctest <!--x13:ctest-->12/12<!--/x13-->, R bindings 165/165 |
| Corpus | <!--x13:corpus_specs-->453<!--/x13--> spec files, <!--x13:parity_modules-->31<!--/x13--> test modules | real + synthetic series |
...
| Commits | <!--x13:commits-->416<!--/x13--> | 2026-07-18 → 2026-07-29 |
