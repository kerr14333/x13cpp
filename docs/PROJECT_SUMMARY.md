...
- **Parity suite result:** **<!--x13:parity_pass-->6000<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->474<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-08-02<!--/x13-->), plus <!--x13:ctest-->12/12<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
- **Corpus:** <!--x13:corpus_specs-->414<!--/x13--> spec files across <!--x13:parity_modules-->31<!--/x13--> parity test modules, spanning the airline model, Census example series, real economic series (unemployment, payroll employment, exports), and unedited production specs from the BLS Current Employment Statistics program.
...
- **Census bugs catalogued:** <!--x13:census_bugs-->35<!--/x13--> (CB-1 … CB-<!--x13:census_bugs-->35<!--/x13-->), each either reproduced bug-for-bug against the oracle or recorded with the reason it cannot be (unreachable, or a save-file artefact this port does not write).
...
| Metric | Value | Notes |
|---|---|---|
| C++ written | **<!--x13:cpp_lines-->47228<!--/x13--> non-blank lines**, <!--x13:cpp_files-->182<!--/x13--> files | excludes generated COMMON headers |
...
| Parity result | <!--x13:parity_pass-->6000<!--/x13--> pass / <!--x13:parity_fail-->0<!--/x13--> fail / <!--x13:parity_xfail-->0<!--/x13--> xfail / <!--x13:parity_skip-->474<!--/x13--> skip | plus ctest 11/11, R bindings 165/165 |
| Corpus | <!--x13:corpus_specs-->414<!--/x13--> spec files, <!--x13:parity_modules-->31<!--/x13--> test modules | real + synthetic series |
| Census bugs catalogued | <!--x13:census_bugs-->35<!--/x13--> (CB-1 … CB-<!--x13:census_bugs-->35<!--/x13-->) | reproduced bug-for-bug, or recorded as unreachable |
| Active development time | **<!--x13:active_time-->60h 33m<!--/x13-->** over <!--x13:calendar_days-->16<!--/x13--> calendar days | `worklog.py`, gaps >45m excluded |
| Commits | <!--x13:commits-->390<!--/x13--> | 2026-07-18 → 2026-07-29 |
