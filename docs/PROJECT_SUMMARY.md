...
- **Parity suite result:** **<!--x13:parity_pass-->5754<!--/x13--> passed · <!--x13:parity_fail-->0<!--/x13--> failed · <!--x13:parity_xfail-->0<!--/x13--> xfailed · <!--x13:parity_skip-->469<!--/x13--> skipped** (as of <!--x13:last_commit-->2026-07-29<!--/x13-->), plus <!--x13:ctest-->11/11<!--/x13--> unit tests and 165/165 R-binding tests. Runs in ~85s on 8 workers.
- **Corpus:** <!--x13:corpus_specs-->398<!--/x13--> spec files across <!--x13:parity_modules-->28<!--/x13--> parity test modules, spanning the airline model, Census example series, real economic series (unemployment, payroll employment, exports), and unedited production specs from the BLS Current Employment Statistics program.
...
- **Census bugs catalogued:** <!--x13:census_bugs-->33<!--/x13--> (CB-1 … CB-<!--x13:census_bugs-->33<!--/x13-->), each either reproduced bug-for-bug against the oracle or recorded with the reason it cannot be (unreachable, or a save-file artefact this port does not write).
...
| Metric | Value | Notes |
|---|---|---|
| C++ written | **<!--x13:cpp_lines-->44893<!--/x13--> non-blank lines**, <!--x13:cpp_files-->180<!--/x13--> files | excludes generated COMMON headers |
